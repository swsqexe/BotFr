...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
                        return message.reply("<a:Loading:1161607247311421462> Connecting...")
      let Truchorkodc = client.guilds.cache.get("773668217163218944")
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/utmuExHwyT")
