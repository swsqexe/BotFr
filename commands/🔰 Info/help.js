  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("<a:Support_Server:1156122237234069515>").setLabel("Support Server").setURL("https://discord.gg/AFYHSWSJXB")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
...
`>>> **58+ Systems**, like: <:Twitter:1156127703490109470> **Twitter-** & <:YouTube:1156128039646801991> **Youtube-Auto-Poster** 
**Application-**, <:Ticket:1156129515043569734> Ticket, <a:welcoming:1142699032070869074> **Welcome-Images** and
 <:Reaction_role:1156130233292947486> Reaction Role etc.
 <:system:1156133830072221786> **__Sytems Like__*
<a:Music:1156197872224706560> An advanced <:Spotify:1156129087270699038> **Music System** with **Audio Filtering**
<a:Games:1156235023071059999> Many **Minigames** and **Fun** Commands (150+)
<a:Admin:1156234655889100860> Administration and Auto-Moderation and way much more!`)
...
<:truchorko_dev:990314040721031228> Made by **[Team Arcades](https://discord.gg/utmuExHwyT)**
<:MilratoDevelopment:900389724936609842> Made by **[Milrato Development](https://discord.gg/fCqnAfwekA)**`)
...
*/
        ...
        function allotherembeds_eachcategory(filterdisabled = false){
          ...
          var embed1 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "💸 Economy").size}\`] 💸 Economy Commands 💸 | ${settings.ECONOMY ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
            ...
            .addField(`<:Builder:1161359707504648283> **Information & Manage 💸**`,  ">>> " + client.commands.filter((cmd) => cmd.category === "💸 Economy" && cmd.type === "info").sort((a,b) => a.name.localeCompare(b?.name)).map((cmd) => `\`${cmd.name}\``).join("︲"))
            if(!filterdisabled || settings.ECONOMY || settings.showdisabled) embeds.push(embed1)

          //SCHOOL COMMANDS
          var embed2 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🏫 School Commands").size}\`] 🏫 School Commands 🏫 | ${settings.SCHOOL ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed3 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎶 Music").size}\`] 🎶 Music Commands 🎶 | ${settings.MUSIC ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
            ...
            .addField("<a:MusicDisk:1161641090907123764> **Song Commands**", "> "+client.commands.filter((cmd) => cmd.category === "🎶 Music" && cmd.type.includes("song")).sort((a,b) => a.name.localeCompare(b?.name)).map((cmd) => `\`${cmd.name}\``).join("︲"))
          ...
          var embed4 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "👀 Filter").size}\`] 👀 Filter Commands 👀 | ${settings.FILTER ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed5 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "⚜️ Custom Queue(s)").first().extracustomdesc.length}\`] ⚜️ Custom Queue(s) Commands ⚜️ | ${settings.CUSTOMQUEUE ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
            .setDescription(`> *${client.commands.filter((cmd) => cmd.category === "⚜️ Custom Queue(s)").first().extracustomdesc.split(",").map(i => i?.trim()).join("︲")}*`)
            .addField("\u200b", "\u200b")
            .addField("<a:Yes:1156196509029761034>  **Usage**", "> "+client.commands.filter((cmd) => cmd.category === "⚜️ Custom Queue(s)").first().usage)
          ...
          var embed7 = new MessageEmbed()
            ...
            .addField("<:DTron:1161359472619442238> **Most used Systems**", "> "+client.commands.filter((cmd) => cmd.category === "💪 Setup" && cmd.type.includes("system")).sort((a,b) => a.name.localeCompare(b?.name)).map((cmd) => `\`${cmd.name}\``).join("︲"))
          ...
          var embed9 = new MessageEmbed()
            ...
            .addField("\u200b", "__**Sub-Categorized Commands:**__")
            .addField("<:discord:1161640446649434112> **Information & Manage**", "> "+client.commands.filter((cmd) => cmd.category === "👑 Owner" && cmd.type.includes("info")).sort((a,b) => a.name.localeCompare(b?.name)).map((cmd) => `\`${cmd.name}\``).join("︲"))
          ...
          var embed10 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "⌨️ Programming").size}\`] ⌨️ Programming Commands ⌨️ | ${settings.PROGRAMMING ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed11 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "📈 Ranking").size}\`] 📈 Ranking Commands 📈 | ${settings.RANKING ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed12 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🔊 Soundboard").size}\`] 🔊 Soundboard Commands 🔊 | ${settings.SOUNDBOARD ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed13 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎤 Voice").first().extracustomdesc.length}\`] 🎤 Voice Commands 🎤 | ${settings.VOICE ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
            .setDescription(`> *${client.commands.filter((cmd) => cmd.category === "🎤 Voice").first().extracustomdesc.split(",").map(i => i?.trim()).join("︲")}*`)
            .addField("\u200b", "\u200b")
            .addField("<a:Yes:1156196509029761034>  **Usage**", "> "+client.commands.filter((cmd) => cmd.category === "🎤 Voice").first().usage)
          if(!filterdisabled || settings.VOICE || settings.showdisabled) embeds.push(embed13)

          //FUN COMMANDS
          var embed14 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🕹️ Fun").size}\`] 🕹️ Fun Commands 🕹️ | ${settings.FUN ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed15 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎮 MiniGames").size}\`] 🎮 Mini Games Commands 🎮 | ${settings.MINIGAMES ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
            .addField("\u200b", "__**Sub-Categorized Commands:**__")
          ...
          var embed16 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "😳 Anime-Emotions").size}\`] 😳 Anime Commands 😳 | ${settings.ANIME ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed17 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🔞 NSFW").size}\`] 🔞 NSFW Commands 🔞 | ${settings.NSFW ? "<a:Yes:1156196509029761034> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
