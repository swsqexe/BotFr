        ...
        if (args[0].toLowerCase() === "start") {
            try{
                ...
                let options = {
                    ...
                    prize: `<a:gift:1174373826545582140> ${giveawayPrize} <a:gift:1174373826545582140>`,
                    ...
                    messages: {
                        ...
                        dropMessage: "Be the first to react with :tada: ",
                        noWinner: "\n**Giveaway cancelled!**\n> No valid participations. :cry:",
                        endedAt: "Ends at", 
                        giveaway: ':tada:  **GIVEAWAY STARTED** :tada: ',
            ...
            client.giveawaysManager.reroll(giveaway.messageId, { winnerCount: !isNaN(args[1]) ? Number(args[1]) : 1})
                ...
                .catch((e) => {
                    if (e.startsWith(`Giveaway with message Id ${giveaway.messageId} is not ended.`)) {
                        ...
                        console.error(e);
                        message.reply({content : '<a:no:1156196552373702656> **An error occured...**```' + String(e.message).substr(0, 1900) + "```"});
                    }
                });
