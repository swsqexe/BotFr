  ...
  client.on("guildMemberAdd", async mem => {
    ...
    async function welcome(member) {
      ...
      if (invite && inviter) {
        ...
        invitemessage = `Invited by ${inviter.tag ? `**${inviter.tag}**` : `<@${inviter.id}>`}\n<:invites:1157721920339456131> **${realinvites} Invite${realinvites == 1 ? "" : "s"}**\n[<:Join:1158073614231408650> ${invites} Joins | <:leave:1158073519989604504> ${leaves} Leaves | <a:No:1156196552373702656> ${fake} Fakes]`;
      } 
      else if(invite){
